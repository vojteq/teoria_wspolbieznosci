...
public class Monitor {
    private LinkedList<Integer> producersTickets;
    private LinkedList<Integer> consumersTickets;
    private int maxSize;
    ...
    public Monitor(int maxSize) {
        producersTickets = new LinkedList<>();
        consumersTickets = new LinkedList<>();
        random = new Random();
    ...
    public void getProducerTicket() throws InterruptedException {
        lock.lock();
        try {
            while (producersTickets.size() == 0) {
